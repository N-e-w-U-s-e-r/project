class Chart {
    constructor(container, samples, options, onClick = null) {
        ...
        this.overlayCanvas.imageSmoothingEnabled = false;
    ...
    #addEventListeners() {
        ...
        canvas.onwheel = (evt) => {
            ...
            // dataTrans.scale = Math.max(step, Math.min(2, dataTrans.scale)); //important
    ...
    #emphasizeSample(sample, color = "cyan") {
        const pLoc = math.remapPoint(
            this.dataBounds, this.pixelBounds,
            sample.point
        );
    ...
    #drawAxes() {
        ...
        const dataMin = math.remapPoint(this.pixelBounds,
            this.dataBounds,
            [left, bottom]
        );
        graphics.drawText(ctx, {
        ...
        ctx.restore();
        const dataMax = math.remapPoint(this.pixelBounds,
            this.dataBounds,
            [right, top]
        );
        graphics.drawText(ctx, {
